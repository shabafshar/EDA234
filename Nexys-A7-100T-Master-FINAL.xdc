...
## LEDs
set_property -dict { PACKAGE_PIN H17   IOSTANDARD LVCMOS33 } [get_ports { Kill_Light }]; #IO_L18P_T2_A24_15 Sch=led[0]
set_property -dict { PACKAGE_PIN K15   IOSTANDARD LVCMOS33 } [get_ports { UART_LED }]; #IO_L24P_T3_RS1_15 Sch=led[1]
...
##Pmod Headers
##Pmod Header JA
set_property -dict { PACKAGE_PIN C17   IOSTANDARD LVCMOS33 } [get_ports { Port1 }]; #IO_L20N_T3_A19_15 Sch=ja[1] (JA[0])
set_property -dict { PACKAGE_PIN D18   IOSTANDARD LVCMOS33 } [get_ports  { Reciever1 }]; #IO_L21N_T3_DQS_A18_15 Sch=ja[2] (JA[1])
set_property -dict { PACKAGE_PIN E18   IOSTANDARD LVCMOS33 } [get_ports { Speakerport }]; #IO_L21P_T3_DQS_15 Sch=ja[3] (JA[2])
#set_property -dict { PACKAGE_PIN G17   IOSTANDARD LVCMOS33 } [get_ports { JA[3] }]; #IO_L18N_T2_A23_15 Sch=ja[4] (JA[3])
...
##Pmod Header JB
set_property -dict { PACKAGE_PIN D14   IOSTANDARD LVCMOS33 } [get_ports { UART_port }]; #IO_L1P_T0_AD0P_15 Sch=jb[1]
...
##Pmod Header JD
set_property -dict { PACKAGE_PIN H4    IOSTANDARD LVCMOS33 } [get_ports { Reciever2 }]; #IO_L21N_T3_DQS_35 Sch=jd[1]
